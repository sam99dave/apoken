...
contract PatientRecords is InterfacePatientRecords, TokenDestructible {
    ...
    * Constans
    */
    uint256 public constant MAX_COUNT = 50;
    ...
    * Modifiers
    */
    modifier validParameters(uint256 count) {
    ...
    function getCurrentPatients(uint256 from, uint256 to)
        public
        view
        hospitalExist(msg.sender)
        returns (uint256 _numberOfPatients)
    {
        uint256 i;
        _numberOfPatients = 0;
